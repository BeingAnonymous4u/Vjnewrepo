...
BOT_TOKEN = environ.get('BOT_TOKEN', "7272735872:AAHq1CBGqfpShe4lANk7irv7u22qDE0FwlM")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1182797039').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001666363760').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '1182797039').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://mrsanthoshvip111:TPsCp3P0CSlhohOV@cluster0.n7rjhs2.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'Mr_Santhosh_28') # owner username without @
...
SHORTLINK_API = environ.get('SHORTLINK_API', '573f2de30f4d74c007fee3cdf1a540c1697c7e08')

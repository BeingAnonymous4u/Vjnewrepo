...
auth_channel = environ.get('AUTH_CHANNEL', '-1002021217229') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://ii7gbfk91p05:ha3TllXC99F3N9EQ@cluster0.wgmua.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'Rolexhxd') # owner username without @

# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+kstxmybhcg44ZWE1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/hdhindibackup')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/AllMoviesHouse/2')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'imdbchatroom') # Support Chat Link Without https:// or @
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://political-nerti-vjnewrepostiry-3910f8fd.koyeb.app/")
